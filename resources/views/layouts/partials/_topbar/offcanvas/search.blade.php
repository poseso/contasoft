...
<div id="kt_offcanvas_toolbar_search" class="kt-offcanvas-panel">
	<div class="kt-offcanvas-panel__head">
		...
		<a href="#" class="kt-offcanvas-panel__close" id="kt_offcanvas_toolbar_search_close">
	...
	<div class="kt-offcanvas-panel__body">
		<!-- begin:: Quick Search -->
		<div class="kt-quick-search kt-quick-search--offcanvas" id="kt_quick_search_offcanvas">
			<form method="get" action="" class="kt-quick-search__form">
				<div class="input-group">
					...
					<input type="text" class="form-control kt-quick-search__input" placeholder="{{ __('Escriba aquí...') }}" name="query">
					...
					<div class="kt-quick-search__section">
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img kt-quick-search__item-img--file">
								<img src="{{ asset('media/files/doc.svg') }}" alt="" />
							</div>
						...
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img kt-quick-search__item-img--file">
								<img src="{{ asset('media/files/pdf.svg') }}" alt="" />
							</div>
						...
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img kt-quick-search__item-img--file">
								<img src="{{ asset('media/files/zip.svg') }}" alt="" />
							</div>
						...
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img kt-quick-search__item-img--file">
								<img src="{{ asset('media/files/xml.svg') }}" alt="" />
							</div>
					...
					<div class="kt-quick-search__section">
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img">
								<img src="{{ asset('media/users/300_11.jpg') }}" alt="" />
							</div>
						...
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img">
								<img src="{{ asset('media/users/300_16.jpg') }}" alt="" />
							</div>
						...
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img">
								<img src="{{ asset('media/users/300_22.jpg') }}" alt="" />
							</div>
						...
						<div class="kt-quick-search__item">
							<div class="kt-quick-search__item-img">
								<img src="{{ asset('media/users/300_5.jpg') }}" alt="" />
							</div>
