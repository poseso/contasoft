...
{{ style('custom/ladda/ladda.min.css') }}
{{ style('custom/pnotify/pnotify.css') }}
{{ style('custom/pnotify/pnotify.brighttheme.css') }}
...
@push('after-scripts')
    {!! script('custom/ladda/spin.min.js') !!}
    {!! script('custom/ladda/ladda.min.js') !!}
    {!! script('custom/pnotify/pnotify.js') !!}
    <script>
